        ...
        <>
            <div className='container '>
                <div className="clearfix">
                    ...
                    <a href={link}>
                        <img src={image} className="slideimage img-fluid col-md-6 float-md-start mb-3 me-md-3" style={{ borderRadius: "12px" }} alt="..." />
                        </a>
                        <div className='d-flex flex-column justify-content-center justify-content-md-start align-items-md-start align-items-center '>
                            {title.length<15?<h3>{title.slice(0,10)}<br/>
                            {title.slice(10,15)}</h3>:<h3>{title}</h3>}
                            <h6 className='genres d-md-block d-none' >Genres:<a className='mx-2'>{genres1}</a><a className='mx-2'>{genres2}</a><a className='mx-2'>{genres3}</a><a className='mx-2'>{genres4}</a></h6>
                            <p>{synopsis}</p>
