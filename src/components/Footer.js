...
import imagef from '../assets/images/footer.jpg'
  ...
  return (
    <div>
      <div className='position-absolute'>
        <img src={imagef} alt='background' className="img-fluid" style={{ height: "230px", width: "100vw", objectFit: "cover", filter: "brightness(0.18)" }} />
      </div>

      <div className='mt-5 position-relative' style={{ backdropFilter: "grayscale(0.8)" }}>
          ...
          <footer className="d-flex flex-wrap flex-column flex-md-row justify-content-md-between justify-content-evenly align-items-center pt-3 mt-4 border-top" style={{ height: "230px" }}>
            ...
            <div className='col-md-4 link-dark text-decoration-none'>
              ...
              <div className='d-flex text-white justify-content-center'>
                <a href='/' className='text-white' aria-label="Telegram"><i className="fa-brands fa-telegram fa-lg px-2"></i></a>
                <a href='/' className='text-white' aria-label="Discord"><i className="fa-brands fa-discord fa-lg px-2"></i></a>
                <a href='/' className='text-white' aria-label="Twitter"><i className="fa-brands fa-twitter fa-lg px-2"></i></a>
                <a href='/' className='text-white' aria-label="Facebook"><i className="fa-brands fa-facebook fa-lg px-2"></i></a>
              </div>
            </div>
